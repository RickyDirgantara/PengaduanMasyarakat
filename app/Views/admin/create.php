        ...
        <div class="content">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Form Tindak Lanjut</h6>
                            <div class="form-floating mb-3">
                            <form action="/storeFollowUps" method="post">
            <input type="hidden" name="ComplaintID" value="<?= $complaintID; ?>">

            <div class="mb-3">
                <label for="TanggalTindakLanjut" class="form-label">Tanggal Tindak Lanjut</label>
                <input type="date" class="form-control" id="TanggalTindakLanjut" name="TanggalTindakLanjut" required>
            </div>

            <div class="mb-3">
                <label for="DeskripsiTindakLanjut" class="form-label">Deskripsi Tindak Lanjut</label>
                <textarea class="form-control" id="DeskripsiTindakLanjut" name="DeskripsiTindakLanjut" rows="4" required></textarea>
            </div>
